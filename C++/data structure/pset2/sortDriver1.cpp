...
void printList(int *list, int N, int max_print, int per_line) {
	cout << ">printList...N=" << N << " max_print=" << max_print << endl;
...
int main(int argc, char *argv[]) {
	...
	do {
		sprintf(option_str, "[sort=%s N=%d randomized=%c max_print=%d per_line=%d]",algorithm_list[algorithm_chosen], N, randomized, max_print, per_line);
		cout << "\n\tOPTIONS: " << option_str << "\n"
		...
		switch (option_char) {
		case 'a': cout << "case = " << option_char << endl;
		...
		case 'r': cout << "case = " << option_char << endl;
			if (N <= 1) {
		...
		case 's': cout << "case = " << option_char << endl;
			if (N <= 0) {
		...
		case 'm': cout << "case = " << option_char << endl;

			cout << "your code here\n";

			break;
		case 'd': cout << "case = " << option_char << endl;
